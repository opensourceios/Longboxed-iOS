...
+ (void)drawDefaultCoverWithColor: (UIColor*)color width: (CGFloat)width height: (CGFloat)height;
{
    ...
    //// Subframes
    CGRect group4 = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.10000 + 0.5), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.22667 - 0.1) + 0.6, floor(CGRectGetWidth(frame) * 0.91157 - 0.08) - floor(CGRectGetWidth(frame) * 0.10000 + 0.5) + 0.58, floor(CGRectGetHeight(frame) * 0.77867 + 0.5) - floor(CGRectGetHeight(frame) * 0.22667 - 0.1) - 0.6);
...
+ (UIImage*)imageOfDefaultCoverWithColor: (UIColor*)color width: (CGFloat)width height: (CGFloat)height;
{
    ...
    [PaintCodeImages drawDefaultCoverWithColor: color width: width height: height];
