...
+ (void)drawArrowWithColor: (UIColor*)color width: (CGFloat)width;
{
    ...
    //// Subframes
    CGRect page = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.01362 - 0.07) + 0.57, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.03410 - 0.22) + 0.72, floor(CGRectGetWidth(frame) * 0.98422 + 0.16) - floor(CGRectGetWidth(frame) * 0.01362 - 0.07) - 0.23, floor(CGRectGetHeight(frame) * 0.90272 + 0.45) - floor(CGRectGetHeight(frame) * 0.03410 - 0.22) - 0.68);
...
+ (void)drawLongboxedLogoWithColor: (UIColor*)color width: (CGFloat)width;
{
    ...
    //// Subframes
    CGRect group4 = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.02143 - 0.4) + 0.9, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.01333 + 0.46) + 0.04, floor(CGRectGetWidth(frame) * 0.98759 + 0.02) - floor(CGRectGetWidth(frame) * 0.02143 - 0.4) - 0.42, floor(CGRectGetHeight(frame) * 0.99905 + 0.06) - floor(CGRectGetHeight(frame) * 0.01333 + 0.46) + 0.4);
...
+ (void)drawMagnifyingGlassWithColor: (UIColor*)color width: (CGFloat)width;
{
    ...
    //// Subframes
    CGRect group = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.02381 - 0.5) + 1, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.02381 + 0.25) + 0.25, floor(CGRectGetWidth(frame) * 0.97078 - 0.27) - floor(CGRectGetWidth(frame) * 0.02381 - 0.5) - 0.23, floor(CGRectGetHeight(frame) * 0.99405 + 0.5) - floor(CGRectGetHeight(frame) * 0.02381 + 0.25) - 0.25);
