...
- (NSString *)interpolateWithObject:(id)object addingEscapes:(BOOL)addEscapes
{
    ...
    RKPathMatcher *matcher = [RKPathMatcher pathMatcherWithPattern:self];
    NSString *interpolatedPath = [matcher pathFromObject:object addingEscapes:addEscapes interpolatedParameters:nil];
