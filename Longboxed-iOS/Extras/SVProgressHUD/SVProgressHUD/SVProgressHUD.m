...
static CGFloat SVProgressHUDWidth;
static CGFloat SVProgressHUDHeight;
...
static const CGFloat SVProgressHUDDefaultSize = 400;
...
{
    SVProgressHUDWidth = width;
    SVProgressHUDHeight = height;
}
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.maskType) {
        ...
        case SVProgressHUDMaskTypeClear: break;
        case SVProgressHUDMaskTypeNone: break;
    }
}

- (void)updatePosition {
	
    CGFloat hudWidth = SVProgressHUDWidth;
    CGFloat hudHeight = SVProgressHUDHeight;
...
- (void)showImage:(UIImage *)image status:(NSString *)string duration:(NSTimeInterval)duration {
    ...
    SVProgressHUDWidth = SVProgressHUDDefaultSize;
    SVProgressHUDHeight = SVProgressHUDDefaultSize;
}
